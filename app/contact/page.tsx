      ...
      >
        ...
        <Container size="wide" padding="default">
          <div className="grid items-start gap-5 pb-8 pt-20 sm:gap-7 sm:pb-12 sm:pt-24 lg:grid-cols-[1.08fr_0.92fr] lg:gap-8 lg:py-40 xl:gap-10">
            {/* LEFT: FORM */}
            <div className="self-start rounded-[26px] border border-charcoal/8 bg-white/92 p-5 shadow-[0_16px_42px_rgba(44,44,44,0.07)] sm:rounded-4xl sm:p-7 lg:rounded-[34px] lg:p-9">
