...
function StatCard({
  ...
  return (
    <motion.article
      ...
      className="relative flex min-h-[12.5rem] flex-col items-center justify-center rounded-[1.75rem] border border-white/70 bg-white/80 px-6 pb-7 pt-12 text-center  lg:min-h-[13.5rem]"
    >
