...
export default function NewsletterCTASection({
  ...
  return (
    ...
    >
      ...
      <Container
        size="wide"
        className="relative z-10 flex min-h-svh items-center py-16 sm:py-20 lg:py-24"
      >
        <div className="mx-auto w-full max-w-5xl">
          ...
          <div className="mt-8 grid gap-5 lg:mt-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-6">
            ...
            <ScrollReveal delay="md" className="hidden md:block">
              <div className="relative overflow-hidden rounded-4xl border border-white/50 bg-charcoal px-5 py-6 text-cream shadow-[0_18px_60px_rgba(44,44,44,0.10)] sm:px-7 sm:py-8">
                <div
                  aria-hidden="true"
