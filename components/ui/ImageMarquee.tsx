...
export default function ImageMarquee({
  ...
  return (
    <div
      className={`relative w-full overflow-hidden [mask-image:linear-gradient(90deg,transparent_0%,black_10%,black_90%,transparent_100%)] ${className}`}
    >
      <div
        className={`flex w-max gap-4 will-change-transform motion-reduce:animate-none sm:gap-5 lg:gap-6 ${speedClass[speed]} ${directionClass[direction]}`}
      >
