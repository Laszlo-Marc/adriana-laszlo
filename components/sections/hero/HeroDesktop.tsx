      ...
      >
        <Container size="full" padding="none">
          <div className="relative mx-auto min-h-[820px] max-w-[1600px] px-8 pb-20 pt-24 xl:min-h-[880px] xl:px-12 xl:pt-28">
            ...
            <div
              aria-hidden="true"
              className="absolute left-[18%] top-[18%] h-72 w-72 rounded-full bg-teal-soft/40 blur-3xl"
            />
            <div
              aria-hidden="true"
              className="absolute right-[14%] top-[22%] h-80 w-80 rounded-full bg-sand/60 blur-3xl"
            />
            ...
            <div className="relative z-10 mx-auto flex min-h-[620px] max-w-4xl flex-col items-center justify-center text-center">
              ...
              >
                ...
                atașament, într-un cadru sigur, profund și orientat spre
                schimbare reală.
              </Text>
